  ...
  , children: [
      ...
      , Node { title: "WTF?"
             ...
             , dataSource: MemorySource (joinWith "\n" [
                ...
                , ""
                , ""
                , "To run in a browser, just open [eugenen.github.io](http://eugenen.github.io/) and then follow instructions. "
                , "There are 2 distinct user interfaces for browsers: "
                , "- conventional HTML-based, rendered using virtual dom;"
                , "- REPL based using Javascript console. After switching to this mode one has to open Javascript console and "
                , "  use functions provided to interact with the application."
                , ""
                , ""
                , "Another option is to run the application without browser. Just save the very same `app.js` file, which is used "
